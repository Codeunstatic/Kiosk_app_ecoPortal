...
export default function SafetyTrainingScreen({ contractor, onComplete, onBack }) {
        ...
        <div className="screen-content">
          ...
          <div className="alert alert-warning" style={{ marginBottom: 24 }}>
            ...
            <div className="alert-body">
              <h4>Your onboarding is incomplete</h4>
              <p>Complete the safety training below to be fully onboarded — it takes less than 5 minutes.</p>
              <p style={{ marginTop: 4, fontSize: 12, fontWeight: 700, color: '#9CA3AF', letterSpacing: '0.05em' }}>
                STEP 3 OF 3 – SAFETY TRAINING
              </p>
            </div>
          </div>
          ...
          <div className="safety-card safety-card--security">
            ...
            <div className={`ack-item${ack2 ? ' checked' : ''}`} onClick={() => setAck2(v => !v)}>
              <div className={`ack-checkbox${ack2 ? ' checked' : ''}`}>
                {ack2 && (
                  <svg width="9" height="7" viewBox="0 0 9 7" fill="none">
                    <path d="M1 3.5L3.5 6L8 1" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
